...
sys.path.append(os.path.join(parent_dir, '../../G3FlowDP/dp'))
...
def main(cfg):
    ...
    save_dir  = f'result_feature_dp_ablation/{cfg.raw_task_name}_{cfg.expert_data_num}_{cfg.sample_num}_{cfg.n_components}_{cfg.feature_type}_{cfg.training.seed}'
...
def test_policy(Demo_class, args, feature_dp, st_seed, test_num=20, cfg=None):
    ...
    while succ_seed < test_num:
        ...
        Demo_class.apply_g3flow_dp_ablation(feature_dp, info=info, dino=dino, cfg=cfg, sample_num=cfg.sample_num)
