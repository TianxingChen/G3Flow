...
class DP:
    def __init__(self, task_name, checkpoint_num: int, data_num: int, seed: int):
        self.policy = get_policy(f'checkpoints/{task_name}_{data_num}_{seed}/{checkpoint_num}.ckpt', None, 'cuda:0')
...
def main(usr_args):
    ...
    dp = DP(task_name, checkpoint_num, usr_args.data_num, seed)
    ...
    file_path = save_dir / f'result_{checkpoint_num}_ckpt_{seed}.txt'
